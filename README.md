...
# Git-Setup für HA
![](_bilder\img1.PNG "Ordner soll leer sein")
...
```
![](_bilder\img2.PNG "Rechtsklick -> Git Bash")
![](_bilder\img3.PNG "Clone a Repo")
![](_bilder\img4.PNG "So sollte das jetzt aussehen")
...
git pull
```
![](_bilder\img5.PNG "Existierende Repo")
![](_bilder\img6.PNG "Git pull")
